...
<body>
<input type="hidden" value="${organization.id}" id="orgId"/>
<input type="hidden" value="${organization.name}" id="oldName"/>
<div class="openWin-container">
    ...
    <div class="input-group openWin-input">
        <div>
            <span>组织结构名称：</span><br/>
            <input placeholder="组织机构名称" id="name" style="width: 200px;" value="${organization.name}"/>
        </div>
