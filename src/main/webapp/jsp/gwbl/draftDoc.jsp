...
<body>
<table class="easyui-datagird" title="登记草稿列表" style="height: auto" id="draftDoc"
...
<div id="toolbar" style="" class="input-group col-md-10">
    ...
    <span>
     ...
     <button class="btn btn-primary btn-sm" style="margin-left: 10px;" id="createRecvDoc" onclick="createRecvDoc()">新建流程</button>
     <button class="btn btn-primary btn-sm" style="margin-left: 10px;" id="gotoNext" onclick="gotoNext()">流程办理</button>
...
<script>
    $(function () {
        ...
        window.onload = function () {
            $('#draftDoc').datagrid('getPager').pagination({
                beforePageText: '第',
...
<script type="text/javascript" src="<%=jsRoot%>recvDoc.js"></script>
</html>
