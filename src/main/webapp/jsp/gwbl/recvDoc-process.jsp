...
<body>
<table class="easyui-datagird" title="在办列表" style="height: auto" id="processDoc"
...
<script>
    $(function () {
        ...
        window.onload = function () {
            $('#processDoc').datagrid('getPager').pagination({
                beforePageText: '第',
...
<script type="text/javascript" src="<%=jsRoot%>recvDoc-process.js"></script>
</html>
